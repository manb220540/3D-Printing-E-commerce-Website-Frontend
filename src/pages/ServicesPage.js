...
// import { FaPrint, FaCogs, FaCode } from 'react-icons/fa'; // Ví dụ icons
...
//       description: 'Cung cấp dịch vụ in 3D chuyên nghiệp từ các file thiết kế của bạn. Đảm bảo độ chính xác và chất lượng vượt trội.',
//     },
//     {
//       icon: <FaCogs size={50} className="text-success mb-3" />,
//       title: 'Thiết Kế Mô Hình 3D',
//       description: 'Đội ngũ chuyên gia của chúng tôi sẽ giúp bạn biến ý tưởng thành mô hình 3D sẵn sàng cho quá trình in ấn.',
//     },
//     {
//       icon: <FaCode size={50} className="text-info mb-3" />,
//       title: 'Tư Vấn Giải Pháp In 3D',
//       description: 'Cung cấp tư vấn chuyên sâu về công nghệ, vật liệu và các giải pháp in 3D tối ưu cho dự án của bạn.',
//     },
//     {
//       icon: <FaPrint size={50} className="text-warning mb-3" />,
//       title: 'In Nguyên Mẫu Nhanh',
//       description: 'Hỗ trợ in nguyên mẫu nhanh chóng, giúp bạn kiểm tra và cải tiến sản phẩm trước khi sản xuất hàng loạt.',
//     },
//   ];
